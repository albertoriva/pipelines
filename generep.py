...
for d in ACT.datasets:
    ...
    script = genereplib.submit_aracne_array(d['dirname'] + "/" + d['name'], tfs=ACT.tfs, aend=ACT.nrounds-1, pval=ACT.pvalue, dpi=ACT.dpi, done="../aracne.@.done")
